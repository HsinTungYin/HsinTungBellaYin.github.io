var kitty = {
    ...
    threats: null,
    meow: function (){ // a function contained as a kkey value pair of an object is called a method
        return "meow";
...
// kitty.travel(); // error because you can invoke undefined as a function

console.log(kitty.future++); // result in a type number with value NaN which is not a number
...
for (key in kitty){ // generics 
    console.log (key);
    kitty[key]; // alternare accessor for objects in javascript
    // kitty["meow" + count];  
}
